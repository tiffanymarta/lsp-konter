    ...
    <div class="card">
        ...
        <form action="/tambah-penjualan" method="post"> 
          ...
          <div class="mb-3">
            ...
            <input type="text" name="kode_penjualan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Kode Penjualan">
          </div>
          <div class="mb-3">
            ...
            <select name="id_barang" class="form-select" aria-label="Default select example">
              ...
              <option value="<?php echo e($data->id_barang); ?>"><?php echo e($data->nama_barang); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Jumlah Beli</label>
            <input type="number" name="jumlah_beli" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Jumlah Beli">
          </div>
...
</html><?php /**PATH C:\laragon\www\lsp-konter\resources\views/tambah-penjualan.blade.php ENDPATH**/ ?>