        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo e($data->tanggal_penjualan); ?></td>
              <td><?php echo e($data->kode_penjualan); ?></td>
              <td><?php echo e($data->nama_barang); ?></td>
              <td><?php echo e($data->jumlah_beli); ?></td>
              <td><?php echo e($data->harga); ?></td>
              <td><?php echo e($data->harga * $data->jumlah_beli); ?></td>
              <td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-7">
                <input type="date" value="<?php echo e(date('Y-m-d')); ?>" class="form-control" id="staticEmail">
              </div>
            </div>
...
</html><?php /**PATH C:\laragon\www\lsp-konter\resources\views/penjualan.blade.php ENDPATH**/ ?>